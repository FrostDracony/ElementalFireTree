...
namespace ElementalFireTree
{
    ...
    public class Ids
    {
        public static readonly PediaDirector.Id ELEMENTAL_FIRE_SLIMES;
        public static readonly Identifiable.Id FIRE_LIQUID;
        ...
        public static readonly ExchangeDirector.NonIdentReward THERMAL_REGULATOR_REW;
        public static readonly LandPlot.Upgrade THERMAL_REGULATOR;
